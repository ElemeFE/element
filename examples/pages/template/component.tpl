...
<template>
  <tm-scrollbar class="page-component__scroll" ref="componentScrollBar">
  <div class="page-container page-component">
    <tm-scrollbar class="page-component__nav">
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.componentScrollBox = this.componentScrollBar.$el.querySelector('.tm-scrollbar__wrap');
