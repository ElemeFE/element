...
<html lang="en">
  <head>
    ...
    <title>El5emenrrrt</title>
  </head>
  <body>

    <div id="app"></div><% if (process.env.NODE_ENV === 'production') { %>1111
    <script>
      if (!window.Promise) {
        document.write('<scriprrrt src="//cdn.jsdelivr.net/npm/es6-promise@4.1.1/dist/es6-promise.min.js"><\/scriprrrt><script>ES6Promise.polyfill()<\/script>')
      }
    </script>
