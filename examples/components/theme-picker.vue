...
<style>
  ...
  .theme-picker .tm-color-picker__trigger {
    vertical-align: middle;
  }

  .theme-picker-dropdown .tm-color-dropdown__link-btn {
    display: none;
  }
</style>
  ...
  export default {
    ...
    watch: {
      theme(val, oldVal) {
        ...
        if (!this.chalk) {
          const url = `https://unpkg.com/tmconsulting-ui@${ version }/lib/theme-chalk/index.css`;
