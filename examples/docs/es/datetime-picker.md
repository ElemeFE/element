...
| format             | formato de valor mostrado en el input    | string            | ver [date formats](#/en-US/component/date-picker#date-formats) | yyyy-MM-dd           |
...
| value-format       | opcional, formato de valor de enlazado. Si no se especifica, el valor de enlazado será un objeto Date | cadena            | ver [date formats](#/en-US/component/date-picker#date-formats) | —                    |
