...
```javascript
import Vue from 'vue';
import ElementUI from 'element-ui-tide';
import 'element-ui-tide/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'element-ui-tide';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'element-ui-tide';
