...
<tm-button v-popover:popover1>Hover to activate</tm-button>
<tm-button v-popover:popover2>Click to activate</tm-button>
<tm-popover
  placement="right"
  title="Title"
  width="200"
  trigger="focus"
  content="this is content, this is content, this is content">
  <tm-button slot="reference">Focus to activate</tm-button>
</tm-popover>
```
:::
...
<tm-popover
  ...
  <tm-table :data="gridData">
    <tm-table-column width="150" property="date" label="date"></tm-table-column>
    <tm-table-column width="100" property="name" label="name"></tm-table-column>
    <tm-table-column width="300" property="address" label="address"></tm-table-column>
  </tm-table>
</tm-popover>

<tm-button v-popover:popover4>Click to activate</tm-button>
...
<tm-popover
  ...
  <div style="text-align: right; margin: 0">
    <tm-button size="mini" type="text" @click="visible2 = false">cancel</tm-button>
    <tm-button type="primary" size="mini" @click="visible2 = false">confirm</tm-button>
  </div>
</tm-popover>

<tm-button v-popover:popover5>Delete</tm-button>
...
|  transition     |  popover transition animation      | string             | — | tm-fade-in-linear |
