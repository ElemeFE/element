...
import locale from 'element-ei/lib/locale/lang/en'
...
import lang from 'element-ei/lib/locale/lang/en'
import locale from 'element-ei/lib/locale'
...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/element-ui[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]zh-CN/, 'element-ei/lib/locale/lang/en')
  ]
}
```
...
import enLocale from 'element-ei/lib/locale/lang/en'
import zhLocale from 'element-ei/lib/locale/lang/zh-CN'
...
import enLocale from 'element-ei/lib/locale/lang/en'
import zhLocale from 'element-ei/lib/locale/lang/zh-CN'
import ElementLocale from 'element-ei/lib/locale'
