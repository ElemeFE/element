<template>
  ...
  >
    ...
    <div
            ...
            ref="slider">
      <div
              class="el-slider__bar el-slider__bar__left"
              :style="barStyleLeft">
      </div>
      <slider-button
              :vertical="vertical"
      ...
      <div
              class="el-slider__bar el-slider__bar__right"
              :style="barStyleRight">
      </div>
    </div>
  </div>
        ...
        computed: {
            ...
            barStyleLeft() {
                if (this.biDirectional) {
                    return this.vertical
                        ? {
                            height: `${50 - this.barSize > 0 ? 50 - this.barSize : 0}%`,
                            bottom: `${this.barSize}%`
                        } : {
                            width: `${50 - this.barSize > 0 ? 50 - this.barSize : 0}%`,
                            left: `${this.barSize}%`
                        };
                } else {
                    return this.vertical
            ...
            barStyleRight() {
                if (this.biDirectional) {
                    return this.vertical
                        ? {
                            height: `${50 - this.barSize < 0 ? this.barSize - 50 : 0}%`,
                            bottom: `${50}%`
                        } : {
                            width: `${50 - this.barSize < 0 ? this.barSize - 50 : 0}%`,
                            left: `${50}%`
                        };
                }
            },
