<template>
  <transition
    ...
    <div
      v-show="visible"
      class="tm-time-range-picker tm-picker-panel tm-popper"
      :class="popperClass">
      <div class="tm-time-range-picker__content">
        <div class="tm-time-range-picker__cell">
          <div class="tm-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="tm-time-range-picker__body tm-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="tm-time-range-picker__cell">
          <div class="tm-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="tm-time-range-picker__body tm-time-panel__content">
            <time-spinner
      ...
      <div class="tm-time-panel__footer">
        <button
          type="button"
          class="tm-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="tm-time-panel__btn confirm"
          @click="handleConfirm()"
