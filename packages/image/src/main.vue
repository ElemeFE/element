<template>
  <div class="el-image">
    ...
    <template v-if="preview">
      <image-viewer :z-index="zIndex" :initial-index="imageIndex" v-show="showViewer" :on-close="closeViewer" :url-list="previewSrcList" :close-on-click-modal="closeOnClickModal"/>
    </template>
  </div>
</template>
