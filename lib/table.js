    ...
    [
      ...
      _c(
        "div",
        {
          ...
          staticClass: "el-table__pagination-wrapper"
        },
        [
          _c("table-pagination", {
            attrs: { store: _vm.store, layout: _vm.layout }
          })
        ],
        1
      )
...
var table_store_typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
table_store_TableStore.prototype.mutations = {
  setData: function setData(states, data) {
    ...
    var sortedData = table_store_sortData(data || [], states);
    var pagedData = this.getCurrentPageData(sortedData);
  ...
  changeSortCondition: function changeSortCondition(states, options) {
    ...
    var sortedData = table_store_sortData(states.filteredData || states._data || [], states);
    var pagedData = this.getCurrentPageData(sortedData);
    states.data = pagedData;
  ...
  setPagination: function setPagination(states, pagination) {
    states._pagination = pagination;
    var newPagination = {};
    if (pagination === false) {
      newPagination = {};
    } else {
      newPagination = merge_default()({}, DEFAULT_PAGINATION, states.pagination, pagination);
  ...
  paginationCurrentChange: function paginationCurrentChange(states, current) {
    var pagination = states.pagination;
    ...
    var newPagination = merge_default()(pagination, {
      currentPage: current
    });
    this.handlePaginationChange(newPagination);
  },

  paginationSizeChange: function paginationSizeChange(states, size) {
    var pagination = states.pagination;
...
table_store_TableStore.prototype.hasPagination = function () {
  return this.states._pagination !== false;
};

table_store_TableStore.prototype.getMaxCurrentPage = function (total) {
...
table_store_TableStore.prototype.isPaginationCurrentControlled = function () {
  var _pagination = this.states._pagination;

  return _pagination && (typeof _pagination === 'undefined' ? 'undefined' : table_store_typeof(_pagination)) === 'object' && 'currentPage' in _pagination;
};

table_store_TableStore.prototype.getCurrentPageData = function (data) {
  ...
  // 否则进行读取分页数据
  var currentPage = this.getMaxCurrentPage(pagination.total || data.length);
...
table_store_TableStore.prototype.handlePaginationChange = function (newPagination) {
  var _this5 = this;

  this.states.pagination = newPagination;
  var filteredData = this.states.filteredData || this.states._data || [];
  var sortedData = table_store_sortData(filteredData, this.states);
  var pagedData = this.getCurrentPageData(sortedData);
...
table_store_TableStore.prototype.loadData = function (row, treeNode) {
  ...
  if (table.lazy && table.load) {
    table.load(row, treeNode, function (data) {
      ...
      var treeData = _this6.states.treeData;
      data.forEach(function (item) {
        ...
        external_vue_default.a.set(_this6.states.lazyTreeNodeMap, rowKey, item);
      });
      _this6.toggleTreeExpansion(parentRowKey);
    });
  }
};
...
var pagination_ = __webpack_require__(44);
var pagination_default = /*#__PURE__*/__webpack_require__.n(pagination_);

// CONCATENATED MODULE: ./packages/table/src/table-pagination.js
...
/* harmony default export */ var table_pagination = ({
  ...
  render: function render() {
    ...
    var _store$states = this.store.states,
        pagination = _store$states.pagination,
        _data = _store$states._data,
        filteredData = _store$states.filteredData;
    ...
    var existDataLength = 0;
    if (filteredData) {
      existDataLength = filteredData.length;
    } else if (_data) {
      existDataLength = _data.length;
    }
    var total = pagination.total || existDataLength;
    if (!(total > 0)) {
      return null;
    }
    var paginationData = {
      props: merge_default()({}, pagination, {
        total: total,
    ...
    return h('el-pagination', external_babel_helper_vue_jsx_merge_props_default()([{ 'class': 'el-table__pagination' }, paginationData]));
  },
