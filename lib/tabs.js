...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_82501cde_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_tab_bar_vue__ = __webpack_require__(296);
var normalizeComponent = __webpack_require__(0)
/* script */
...
var _tabNav = __webpack_require__(294);
...
exports.default = {
  ...
  render: function render(h) {
    ...
    var scrollBtn = scrollable ? [h(
      ...
      [h('i', { 'class': 'siagri-icon-arrow-left' })]
    ), h(
      'span',
      ...
      [h('i', { 'class': 'siagri-icon-arrow-right' })]
    )] : null;
    ...
    var tabs = this._l(panes, function (pane, index) {
      ...
      var btnClose = closable ? h('span', { 'class': 'siagri-icon-close', on: {
