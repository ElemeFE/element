...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_10e0d027_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_tree_vue__ = __webpack_require__(295);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_10e0d027_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_tree_vue__["a" /* default */],
...
var Node = function () {
  ...
  Node.prototype.insertChild = function insertChild(child, index, batch) {
    ...
    if (!(child instanceof Node)) {
      console.log('insertChild instanceof Node=true');
  ...
  Node.prototype.expand = function expand(callback, expandParent) {
    ...
    var done = function done() {
      console.log('expand2 node=' + _this.label + ' expandParent=' + expandParent);
      if (expandParent) {
      ...
      if (draggingNode && dropNode) {
        ...
        if (dropType === 'before') {
          ...
          dropNode.node.expand(function () {
            ...
            // dropNode.node.insertChild(draggingNode.node);
            draggingNode.node.remove();
            emitEvents();
          });
          clrDragState();
