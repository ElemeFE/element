...
exports.default = {
  ...
  render: function render(h) {
    ...
    return h(
      ...
      ), this.rowlength > 0 && this.rowlength - this.data.length > 0 ? h(
        'tbody',
        null,
        [this._l(this.rowlength - this.data.length, function (row, $index) {
          return [h(
            'tr',
            null,
            [_this._l(_this.columns, function (column, cellIndex) {
...
exports.default = {
  ...
  created: function created() {
    ...
    column.renderHeader = function (h, _ref7) {
