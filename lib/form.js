...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e96d62ae_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_form_vue__ = __webpack_require__(279);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e96d62ae_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_form_vue__["a" /* default */],
...
exports.default = {
  ...
  created: function created() {
    ...
    this.$on('el.form.removeField', function (field) {
      if (field.prop) {
        _this.fieldList.splice(_this.fieldList.indexOf(field), 1);
      }
    });
  },
  ...
  methods: {
    ...
    clearValidate: function clearValidate() {
      ...
      var fields = props.length ? this.fieldList.filter(function (field) {
    ...
    validate: function validate(callback) {
      ...
      this.fieldList.forEach(function (field) {
        field.validate('', function (message, field) {
          ...
          if (typeof callback === 'function' && ++count === _this2.fieldList.length) {
    ...
    validateField: function validateField(prop, cb) {
      var field = this.fieldList.filter(function (field) {
